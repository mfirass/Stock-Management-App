...
<div class="row">
    <div class="col-md-8">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="{{route('admin.modifie',$user)}}">
            @csrf
            @method('PUT')
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-10">
                <div class="form-group">
                  ...
                  <input type="tel" class="form-control @error('telephone') is-invalid @enderror" value="{{$user->telephone}}" name="telephone">
                  @error('telephone')
                  <span class="invalid-feedback" role="alert">
                     <strong>{{ $message }}</strong>
                  </span>
