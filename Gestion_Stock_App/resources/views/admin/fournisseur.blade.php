              ...
              <tbody class="font-weight-light">
                ...
                <tr>
                  ...
                  <td class="{{ $fournisseur -> credit > 0 ? 'text-danger' : 'text-info' }}">
                    {{ is_null($fournisseur -> credit) ? '' : $fournisseur -> credit.'Dhs' }}
                  </td>
                  <td class="text-right td-actions">
                    <div class="btn-group" role="group">
                      ...
                      &ensp;
                    <form action="{{ route('fournisseur.delete', $fournisseur->id) }}" method="POST" id="deleteFournisseurForm{{ $fournisseur -> id }}">
                      @csrf
                      @method('DELETE')
                    </form>  
                          ...
                          <div class="card card-profile">
                            ...
                            <h4 class="card-title">{{ $fournisseur -> nom }}</h4>
                              <p class="card-description mx-auto">
                                ...
                                Crédit : {{ is_null($fournisseur -> credit) ? '' : $fournisseur -> credit.'Dhs' }}<br>
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$fournisseur->nom}}" required>
                                    @error('name')
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{$fournisseur->email}}" required>
                                    @error('email')
                                       <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                       </span>
