    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-success">
          ...
          <p class="card-category"> Les employees du magasin</p>
        </div>
        <div class="card-body">
            ...
            <div class="col-md-4">
              <form class="navbar-form">
                <div class="input-group no-border">
                  <input type="text" value="" class="form-control" placeholder="Chercher un employee par nom ..." id="myInput" onkeyup="myFunction()">
                  ...
                  <td class="text-right td-actions">
                    <div class="btn-group" role="group">
                      <button type="button" class="btn btn-info btn-link btn-sm" rel="tooltip" title="A propos" data-toggle="modal" data-target="#employee{{$employee->id}}">
                        <i class="material-icons">info</i>à propos &ensp;
                      </button>&ensp;
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$employee->nom}}">
                                    @error('name')
                              ...
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="salaire" name="salaire" class="form-control @error('salaire') is-invalid @enderror" value="{{$employee->salaire}}">
                                    @error('salaire')
                                       <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                       </span>
          ...
          <form method="POST" action="{{ route('employee.add1') }}">
            ...
            <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label class="bmd-label-floating">Salaire</label>
                    <input type="text" id="salaire" name="salaire" class="form-control @error('salaire') is-invalid @enderror">
                    @error('salaire')
                       <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                       </span>
            ...
            <button type="submit" class="btn btn-success pull-right"><i class="material-icons">create</i>Ajouter le employee</button>
            <div class="clearfix"></div>
          </form>
        </div>
      </div>
